...
# URLs de la app "accounts" que manejan registro, login, perfil y órdenes de usuario
urlpatterns = [
    ...
    # Activación y recuperación de contraseña
    ...
    path(
        "validar_restablecer_contrasena/<uidb64>/<token>/",
        views.validar_restablecer_contrasena,
